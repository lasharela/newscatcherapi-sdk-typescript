...
import { LatestHeadlinesRequest, LatestHeadlinesRequestAPI, LatestHeadlinesResponse } from './latestHeadlines.type'
...
export const latestHeadlines = async (options?: LatestHeadlinesRequest) => {
  ...
  return await api.post<unknown, AxiosResponse<LatestHeadlinesResponse>>('/latest_headlines', {
    ...options,
    ...optionsForAPI,
  })
}
